...
import type { RechargeWorkspaceAccountMutationRequestType, RechargeWorkspaceAccountMutationResponseType, RechargeWorkspaceAccountPathParamsType, RechargeWorkspaceAccount400Type, RechargeWorkspaceAccount401Type, RechargeWorkspaceAccount404Type, RechargeWorkspaceAccount409Type, RechargeWorkspaceAccount412Type, RechargeWorkspaceAccount422Type, RechargeWorkspaceAccount500Type } from "../ts/RechargeWorkspaceAccountType";
import type { UseMutationOptions } from "@tanstack/react-query";

 type RechargeWorkspaceAccountClient = typeof client<RechargeWorkspaceAccountMutationResponseType, RechargeWorkspaceAccount400Type | RechargeWorkspaceAccount401Type | RechargeWorkspaceAccount404Type | RechargeWorkspaceAccount409Type | RechargeWorkspaceAccount412Type | RechargeWorkspaceAccount422Type | RechargeWorkspaceAccount500Type, RechargeWorkspaceAccountMutationRequestType>;
type RechargeWorkspaceAccount = {
    data: RechargeWorkspaceAccountMutationResponseType;
    error: RechargeWorkspaceAccount400Type | RechargeWorkspaceAccount401Type | RechargeWorkspaceAccount404Type | RechargeWorkspaceAccount409Type | RechargeWorkspaceAccount412Type | RechargeWorkspaceAccount422Type | RechargeWorkspaceAccount500Type;
