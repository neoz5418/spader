...
export const listUsersQueryParamsSchema = z
	.object({
		sort: z.lazy(() => listUsersSortOptionsSchema).optional(),
 ...
 */
export const listUsers422Schema = z.union([
...
export const listUsersQueryResponseSchema = z.lazy(
	() => paginatedListUserSchema,
);
export type ListUsersQueryResponseSchema = z.infer<
	typeof listUsersQueryResponseSchema
>;
