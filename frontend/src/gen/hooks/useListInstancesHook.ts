...
import type {
	ListInstances422Type,
	ListInstancesQueryParamsType,
	ListInstancesQueryResponseType,
} from "../ts/ListInstancesType";

type ListInstancesClient = typeof client<
	ListInstancesQueryResponseType,
	ListInstances422Type,
	never
>;
...
export const listInstancesQueryKey = (params?: ListInstances["queryParams"]) =>
	[
		"v5",
...
export function listInstancesQueryOptions(
	params?: ListInstances["queryParams"],
	options: ListInstances["client"]["parameters"] = {},
) {
 ...
 */
export function useListInstancesHook<
	TData = ListInstances["response"],
	TQueryData = ListInstances["response"],
	TQueryKey extends QueryKey = ListInstancesQueryKey,
>(
	params?: ListInstances["queryParams"],
	options: {
		query?: Partial<
...
export const listInstancesSuspenseQueryKey = (
	params?: ListInstances["queryParams"],
) =>
	[
		"v5",
...
export type ListInstancesSuspenseQueryKey = ReturnType<
	typeof listInstancesSuspenseQueryKey
>;
export function listInstancesSuspenseQueryOptions(
	params?: ListInstances["queryParams"],
	options: ListInstances["client"]["parameters"] = {},
) {
 ...
 * @link /apis/compute/v1/instances
 */
export function useListInstancesHookSuspense<
	TData = ListInstances["response"],
	TQueryKey extends QueryKey = ListInstancesSuspenseQueryKey,
>(
	params?: ListInstances["queryParams"],
	options: {
		query?: Partial<
	...
	const { query: queryOptions, client: clientOptions = {} } = options ?? {};
	const queryKey =
		queryOptions?.queryKey ?? listInstancesSuspenseQueryKey(params);
	const query = useSuspenseQuery({
		...(listInstancesSuspenseQueryOptions(
			params,
			clientOptions,
