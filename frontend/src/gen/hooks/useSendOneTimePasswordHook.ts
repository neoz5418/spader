...
import type {
	SendOneTimePassword422Type,
	SendOneTimePasswordMutationRequestType,
	SendOneTimePasswordMutationResponseType,
} from "../ts/SendOneTimePasswordType";

type SendOneTimePasswordClient = typeof client<
	SendOneTimePasswordMutationResponseType,
	SendOneTimePassword422Type,
	SendOneTimePasswordMutationRequestType
>;
 ...
 */
export function useSendOneTimePasswordHook(
	options: {
		mutation?: UseMutationOptions<
			SendOneTimePassword["response"],
			SendOneTimePassword["error"],
