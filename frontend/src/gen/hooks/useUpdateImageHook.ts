...
} from "../ts/UpdateImageType";

type UpdateImageClient = typeof client<
	UpdateImageMutationResponseType,
	UpdateImage422Type,
	never
>;
 ...
 */
export function useUpdateImageHook(
	zone: UpdateImagePathParamsType["zone"],
	name: UpdateImagePathParamsType["name"],
	options: {
	...
	const { mutation: mutationOptions, client: clientOptions = {} } =
		options ?? {};
	const invalidationOnSuccess =
		useInvalidationForMutation("useUpdateImageHook");
	return useMutation({
		mutationFn: async () => {
