...
export const listWorkspacesQueryParamsSchema = z
	.object({
		sort: z.lazy(() => listWorkspacesSortOptionsSchema).optional(),
		direction: z.lazy(() => directionSchema).optional(),
		offset: z.number().int().min(0).default(0).optional(),
		limit: z.number().int().min(1).max(100).default(20).optional(),
	})
	.optional();
export type ListWorkspacesQueryParamsSchema = z.infer<
	typeof listWorkspacesQueryParamsSchema
>;
/**
 * @description Successful Response
 */
export const listWorkspaces200Schema = z.lazy(
 ...
 */
export const listWorkspaces422Schema = z.union([
 ...
 * @description Successful Response
 */
export const listWorkspacesQueryResponseSchema = z.lazy(
	() => paginatedListWorkspaceSchema,
);
export type ListWorkspacesQueryResponseSchema = z.infer<
	typeof listWorkspacesQueryResponseSchema
>;
