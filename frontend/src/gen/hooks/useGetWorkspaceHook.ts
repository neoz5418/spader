...
import type { GetWorkspaceQueryResponseType, GetWorkspacePathParamsType, GetWorkspace400Type, GetWorkspace401Type, GetWorkspace404Type, GetWorkspace422Type, GetWorkspace429Type, GetWorkspace500Type, GetWorkspace503Type } from "../ts/GetWorkspaceType";
import type { QueryObserverOptions, UseQueryResult, QueryKey, UseSuspenseQueryOptions, UseSuspenseQueryResult } from "@tanstack/react-query";

 type GetWorkspaceClient = typeof client<GetWorkspaceQueryResponseType, GetWorkspace400Type | GetWorkspace401Type | GetWorkspace404Type | GetWorkspace422Type | GetWorkspace429Type | GetWorkspace500Type | GetWorkspace503Type, never>;
type GetWorkspace = {
    data: GetWorkspaceQueryResponseType;
    error: GetWorkspace400Type | GetWorkspace401Type | GetWorkspace404Type | GetWorkspace422Type | GetWorkspace429Type | GetWorkspace500Type | GetWorkspace503Type;
    request: never;
