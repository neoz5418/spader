...
export const replaceUserQuotaPathParamsSchema = z.object({
	username: z.string(),
});
export type ReplaceUserQuotaPathParamsSchema = z.infer<
	typeof replaceUserQuotaPathParamsSchema
>;
/**
 * @description Successful Response
 */
export const replaceUserQuota200Schema = z.lazy(() => userQuotaSchema);
export type ReplaceUserQuota200Schema = z.infer<
	typeof replaceUserQuota200Schema
>;
/**
 * @description Unprocessable Entity
 */
export const replaceUserQuota422Schema = z.union([
...
export type ReplaceUserQuota422Schema = z.infer<
	typeof replaceUserQuota422Schema
>;
/**
 * @description Successful Response
 */
export const replaceUserQuotaMutationResponseSchema = z.lazy(
	() => userQuotaSchema,
);
export type ReplaceUserQuotaMutationResponseSchema = z.infer<
	typeof replaceUserQuotaMutationResponseSchema
>;
