...
type ListZonesClient = typeof client<
	ListZonesQueryResponseType,
	ListZones422Type,
	never
>;
...
export const listZonesQueryKey = (params?: ListZones["queryParams"]) =>
	[
		"v5",
...
export function listZonesQueryOptions(
	params?: ListZones["queryParams"],
	options: ListZones["client"]["parameters"] = {},
) {
 ...
 */
export function useListZonesHook<
	TData = ListZones["response"],
	TQueryData = ListZones["response"],
	TQueryKey extends QueryKey = ListZonesQueryKey,
>(
	params?: ListZones["queryParams"],
	options: {
		query?: Partial<
...
export const listZonesSuspenseQueryKey = (params?: ListZones["queryParams"]) =>
	[
		"v5",
		{ url: "/apis/compute/v1/zones" },
		...(params ? [params] : []),
	] as const;
export type ListZonesSuspenseQueryKey = ReturnType<
	typeof listZonesSuspenseQueryKey
>;
export function listZonesSuspenseQueryOptions(
	params?: ListZones["queryParams"],
	options: ListZones["client"]["parameters"] = {},
) {
 ...
 * @link /apis/compute/v1/zones
 */
export function useListZonesHookSuspense<
	TData = ListZones["response"],
	TQueryKey extends QueryKey = ListZonesSuspenseQueryKey,
>(
	params?: ListZones["queryParams"],
	options: {
		query?: Partial<
