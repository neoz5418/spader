...
export const createInstancePathParamsSchema = z.object({
	workspace: z.string(),
});
export type CreateInstancePathParamsSchema = z.infer<
	typeof createInstancePathParamsSchema
>;
/**
 ...
 */
export const createInstance422Schema = z.union([
...
export const createInstanceMutationRequestSchema = z.lazy(
	() => createInstanceRequestSchema,
);
export type CreateInstanceMutationRequestSchema = z.infer<
	typeof createInstanceMutationRequestSchema
>;
/**
 * @description Successful Response
 */
export const createInstanceMutationResponseSchema = z.lazy(
	() => operationSchema,
);
export type CreateInstanceMutationResponseSchema = z.infer<
	typeof createInstanceMutationResponseSchema
>;
