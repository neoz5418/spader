...
export const getFileStorageQueryKey = (
...
export function getFileStorageQueryOptions(
	workspace: GetFileStoragePathParamsType["workspace"],
	zone: GetFileStoragePathParamsType["zone"],
	name: GetFileStoragePathParamsType["name"],
	options: GetFileStorage["client"]["parameters"] = {},
) {
 ...
 */
export function useGetFileStorageHook<
	TData = GetFileStorage["response"],
	TQueryData = GetFileStorage["response"],
	TQueryKey extends QueryKey = GetFileStorageQueryKey,
>(
	workspace: GetFileStoragePathParamsType["workspace"],
	zone: GetFileStoragePathParamsType["zone"],
	name: GetFileStoragePathParamsType["name"],
	options: {
		query?: Partial<
			QueryObserverOptions<
				GetFileStorage["response"],
				GetFileStorage["error"],
				TData,
				TQueryData,
				TQueryKey
			>
	...
	const queryKey =
		queryOptions?.queryKey ?? getFileStorageQueryKey(workspace, zone, name);
	const query = useQuery({
		...(getFileStorageQueryOptions(
			workspace,
			zone,
			name,
			clientOptions,
...
export const getFileStorageSuspenseQueryKey = (
	workspace: GetFileStoragePathParamsType["workspace"],
	zone: GetFileStoragePathParamsType["zone"],
	name: GetFileStoragePathParamsType["name"],
) =>
...
export type GetFileStorageSuspenseQueryKey = ReturnType<
	typeof getFileStorageSuspenseQueryKey
>;
export function getFileStorageSuspenseQueryOptions(
	workspace: GetFileStoragePathParamsType["workspace"],
	zone: GetFileStoragePathParamsType["zone"],
	name: GetFileStoragePathParamsType["name"],
	options: GetFileStorage["client"]["parameters"] = {},
 ...
 * @link /apis/compute/v1/workspaces/:workspace/zones/:zone/file_storages/:name
 */
export function useGetFileStorageHookSuspense<
	TData = GetFileStorage["response"],
	TQueryKey extends QueryKey = GetFileStorageSuspenseQueryKey,
>(
	workspace: GetFileStoragePathParamsType["workspace"],
	zone: GetFileStoragePathParamsType["zone"],
	name: GetFileStoragePathParamsType["name"],
	...
	const queryKey =
		...
		getFileStorageSuspenseQueryKey(workspace, zone, name);
	const query = useSuspenseQuery({
		...(getFileStorageSuspenseQueryOptions(
			workspace,
			zone,
			name,
			clientOptions,
