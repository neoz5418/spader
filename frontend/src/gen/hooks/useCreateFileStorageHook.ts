...
import type {
	CreateFileStorage422Type,
	CreateFileStorageMutationRequestType,
	CreateFileStorageMutationResponseType,
	CreateFileStoragePathParamsType,
} from "../ts/CreateFileStorageType";

type CreateFileStorageClient = typeof client<
	CreateFileStorageMutationResponseType,
	CreateFileStorage422Type,
	CreateFileStorageMutationRequestType
>;
 ...
 */
export function useCreateFileStorageHook(
	workspace: CreateFileStoragePathParamsType["workspace"],
	zone: CreateFileStoragePathParamsType["zone"],
	options: {
		mutation?: UseMutationOptions<
			CreateFileStorage["response"],
			CreateFileStorage["error"],
