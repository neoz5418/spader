...
export const deleteInstancePathParamsSchema = z.object({
	workspace: z.string(),
	name: z.string(),
});
export type DeleteInstancePathParamsSchema = z.infer<
	typeof deleteInstancePathParamsSchema
>;
/**
 ...
 */
export const deleteInstance422Schema = z.union([
 ...
 * @description Successful Response
 */
export const deleteInstanceMutationResponseSchema = z.lazy(
	() => operationSchema,
);
export type DeleteInstanceMutationResponseSchema = z.infer<
	typeof deleteInstanceMutationResponseSchema
>;
