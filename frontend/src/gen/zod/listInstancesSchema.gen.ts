...
export const listInstancesQueryParamsSchema = z
	.object({
	...
	.optional();
export type ListInstancesQueryParamsSchema = z.infer<
	typeof listInstancesQueryParamsSchema
>;
/**
 * @description Successful Response
 */
export const listInstances200Schema = z.lazy(
 ...
 */
export const listInstances422Schema = z.union([
 ...
 * @description Successful Response
 */
export const listInstancesQueryResponseSchema = z.lazy(
	() => paginatedListInstancePublicSchema,
);
export type ListInstancesQueryResponseSchema = z.infer<
	typeof listInstancesQueryResponseSchema
>;
