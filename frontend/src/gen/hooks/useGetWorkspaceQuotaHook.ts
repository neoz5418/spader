...
import type { GetWorkspaceQuotaQueryResponseType, GetWorkspaceQuotaPathParamsType, GetWorkspaceQuota400Type, GetWorkspaceQuota401Type, GetWorkspaceQuota404Type, GetWorkspaceQuota422Type, GetWorkspaceQuota429Type, GetWorkspaceQuota500Type, GetWorkspaceQuota503Type } from "../ts/GetWorkspaceQuotaType";
import type { QueryObserverOptions, UseQueryResult, QueryKey, UseSuspenseQueryOptions, UseSuspenseQueryResult } from "@tanstack/react-query";

 type GetWorkspaceQuotaClient = typeof client<GetWorkspaceQuotaQueryResponseType, GetWorkspaceQuota400Type | GetWorkspaceQuota401Type | GetWorkspaceQuota404Type | GetWorkspaceQuota422Type | GetWorkspaceQuota429Type | GetWorkspaceQuota500Type | GetWorkspaceQuota503Type, never>;
type GetWorkspaceQuota = {
    data: GetWorkspaceQuotaQueryResponseType;
    error: GetWorkspaceQuota400Type | GetWorkspaceQuota401Type | GetWorkspaceQuota404Type | GetWorkspaceQuota422Type | GetWorkspaceQuota429Type | GetWorkspaceQuota500Type | GetWorkspaceQuota503Type;
    request: never;
