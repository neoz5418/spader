...
export const listWorkspacesQueryKey = (
	params?: ListWorkspaces["queryParams"],
) =>
	[
		"v5",
...
export function listWorkspacesQueryOptions(
	params?: ListWorkspaces["queryParams"],
	options: ListWorkspaces["client"]["parameters"] = {},
) {
 ...
 */
export function useListWorkspacesHook<
	TData = ListWorkspaces["response"],
	TQueryData = ListWorkspaces["response"],
	TQueryKey extends QueryKey = ListWorkspacesQueryKey,
>(
	params?: ListWorkspaces["queryParams"],
	options: {
		query?: Partial<
...
export const listWorkspacesSuspenseQueryKey = (
	params?: ListWorkspaces["queryParams"],
) =>
	[
		"v5",
...
export type ListWorkspacesSuspenseQueryKey = ReturnType<
	typeof listWorkspacesSuspenseQueryKey
>;
export function listWorkspacesSuspenseQueryOptions(
	params?: ListWorkspaces["queryParams"],
	options: ListWorkspaces["client"]["parameters"] = {},
) {
 ...
 * @link /apis/workspace/v1/workspaces
 */
export function useListWorkspacesHookSuspense<
	TData = ListWorkspaces["response"],
	TQueryKey extends QueryKey = ListWorkspacesSuspenseQueryKey,
>(
	params?: ListWorkspaces["queryParams"],
	options: {
		query?: Partial<
	...
	const { query: queryOptions, client: clientOptions = {} } = options ?? {};
	const queryKey =
		queryOptions?.queryKey ?? listWorkspacesSuspenseQueryKey(params);
	const query = useSuspenseQuery({
		...(listWorkspacesSuspenseQueryOptions(
			params,
			clientOptions,
