 ...
 */
export const createZone422Schema = z.union([
...
export type CreateZoneMutationRequestSchema = z.infer<
	typeof createZoneMutationRequestSchema
>;
/**
 * @description Successful Response
 */
export const createZoneMutationResponseSchema = z.lazy(() => zoneSchema);
export type CreateZoneMutationResponseSchema = z.infer<
	typeof createZoneMutationResponseSchema
>;
