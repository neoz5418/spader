...
type ListGpuTypesClient = typeof client<
	ListGpuTypesQueryResponseType,
	ListGpuTypes422Type,
	never
>;
...
export const listGpuTypesQueryKey = (params: ListGpuTypes["queryParams"]) =>
	[
		"v5",
...
export function listGpuTypesQueryOptions(
	params: ListGpuTypes["queryParams"],
	options: ListGpuTypes["client"]["parameters"] = {},
) {
 ...
 */
export function useListGpuTypesHook<
	TData = ListGpuTypes["response"],
	TQueryData = ListGpuTypes["response"],
	TQueryKey extends QueryKey = ListGpuTypesQueryKey,
>(
	params: ListGpuTypes["queryParams"],
	options: {
		query?: Partial<
			QueryObserverOptions<
				ListGpuTypes["response"],
				ListGpuTypes["error"],
				TData,
				TQueryData,
				TQueryKey
...
export const listGpuTypesSuspenseQueryKey = (
	params: ListGpuTypes["queryParams"],
) =>
	[
		"v5",
...
export type ListGpuTypesSuspenseQueryKey = ReturnType<
	typeof listGpuTypesSuspenseQueryKey
>;
export function listGpuTypesSuspenseQueryOptions(
	params: ListGpuTypes["queryParams"],
	options: ListGpuTypes["client"]["parameters"] = {},
) {
 ...
 * @link /apis/compute/v1/gpu_types
 */
export function useListGpuTypesHookSuspense<
	TData = ListGpuTypes["response"],
	TQueryKey extends QueryKey = ListGpuTypesSuspenseQueryKey,
>(
	params: ListGpuTypes["queryParams"],
	options: {
		query?: Partial<
	...
	const { query: queryOptions, client: clientOptions = {} } = options ?? {};
	const queryKey =
		queryOptions?.queryKey ?? listGpuTypesSuspenseQueryKey(params);
	const query = useSuspenseQuery({
		...(listGpuTypesSuspenseQueryOptions(
			params,
			clientOptions,
