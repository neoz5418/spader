...
export const listGpuTypesQueryParamsSchema = z.object({
	zone: z.union([z.string(), z.null()]),
	offset: z.number().int().min(0).default(0).optional(),
	limit: z.number().int().min(1).max(100).default(20).optional(),
});
export type ListGpuTypesQueryParamsSchema = z.infer<
	typeof listGpuTypesQueryParamsSchema
>;
/**
 * @description Successful Response
 */
export const listGpuTypes200Schema = z.lazy(
 ...
 */
export const listGpuTypes422Schema = z.union([
 ...
 * @description Successful Response
 */
export const listGpuTypesQueryResponseSchema = z.lazy(
	() => paginatedListGpuTypePublicSchema,
);
export type ListGpuTypesQueryResponseSchema = z.infer<
	typeof listGpuTypesQueryResponseSchema
>;
