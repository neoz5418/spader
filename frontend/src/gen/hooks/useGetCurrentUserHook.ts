...
import type {
	GetCurrentUser422Type,
	GetCurrentUserQueryResponseType,
} from "../ts/GetCurrentUserType";

type GetCurrentUserClient = typeof client<
	GetCurrentUserQueryResponseType,
	GetCurrentUser422Type,
	never
>;
 ...
 */
export function useGetCurrentUserHook<
	TData = GetCurrentUser["response"],
	TQueryData = GetCurrentUser["response"],
 ...
 * @link /apis/user/v1/users/me
 */
export function useGetCurrentUserHookSuspense<
	TData = GetCurrentUser["response"],
...
>(
	...
	const query = useSuspenseQuery({
		...(getCurrentUserSuspenseQueryOptions(
			clientOptions,
