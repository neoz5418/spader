 ...
 */
export async function rechargeWorkspaceAccount(
	workspace: RechargeWorkspaceAccountPathParamsType["workspace"],
	data: RechargeWorkspaceAccountMutationRequestType,
	options: Partial<Parameters<typeof client>[0]> = {},
): Promise<
	ResponseConfig<RechargeWorkspaceAccountMutationResponseType>["data"]
> {
