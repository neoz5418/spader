...
import type {
	DeleteInstancePortForward422Type,
	DeleteInstancePortForwardMutationResponseType,
	DeleteInstancePortForwardPathParamsType,
} from "../ts/DeleteInstancePortForwardType";

type DeleteInstancePortForwardClient = typeof client<
	DeleteInstancePortForwardMutationResponseType,
	DeleteInstancePortForward422Type,
	never
>;
type DeleteInstancePortForward = {
	...
	error: DeleteInstancePortForward422Type;
	request: never;
 ...
 */
export function useDeleteInstancePortForwardHook(
	workspace: DeleteInstancePortForwardPathParamsType["workspace"],
	zone: DeleteInstancePortForwardPathParamsType["zone"],
	name: DeleteInstancePortForwardPathParamsType["name"],
	portForwardName: DeleteInstancePortForwardPathParamsType["port_forward_name"],
	options: {
		mutation?: UseMutationOptions<
			DeleteInstancePortForward["response"],
			DeleteInstancePortForward["error"],
			DeleteInstancePortForward["request"]
		>;
	...
	const invalidationOnSuccess = useInvalidationForMutation(
		"useDeleteInstancePortForwardHook",
	);
	return useMutation({
		mutationFn: async () => {
			const res = await client<
				DeleteInstancePortForward["data"],
				DeleteInstancePortForward["error"],
				DeleteInstancePortForward["request"]
			>({
				method: "delete",
