 ...
 */
export const auth422Schema = z.union([
...
export const authMutationRequestSchema = z.lazy(
	() => bodyAuthApisOidcV1AuthPostSchema,
);
export type AuthMutationRequestSchema = z.infer<
	typeof authMutationRequestSchema
>;
/**
 * @description Successful Response
 */
export const authMutationResponseSchema = z.lazy(() => tokenSchema);
export type AuthMutationResponseSchema = z.infer<
	typeof authMutationResponseSchema
>;
