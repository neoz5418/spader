...
export const updateUserQuotaPathParamsSchema = z.object({
	username: z.string(),
});
export type UpdateUserQuotaPathParamsSchema = z.infer<
	typeof updateUserQuotaPathParamsSchema
>;
/**
 ...
 */
export const updateUserQuota422Schema = z.union([
 ...
 * @description Successful Response
 */
export const updateUserQuotaMutationResponseSchema = z.lazy(
	() => userQuotaSchema,
);
export type UpdateUserQuotaMutationResponseSchema = z.infer<
	typeof updateUserQuotaMutationResponseSchema
>;
