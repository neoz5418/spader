...
import type { TokenMutationRequestType, TokenMutationResponseType, Token400Type, Token401Type, Token404Type, Token422Type, Token429Type, Token500Type, Token503Type } from "../ts/TokenType";
import type { UseMutationOptions } from "@tanstack/react-query";

 type TokenClient = typeof client<TokenMutationResponseType, Token400Type | Token401Type | Token404Type | Token422Type | Token429Type | Token500Type | Token503Type, TokenMutationRequestType>;
type Token = {
    data: TokenMutationResponseType;
    error: Token400Type | Token401Type | Token404Type | Token422Type | Token429Type | Token500Type | Token503Type;
