 ...
 */
export async function getWorkspaceAccountRecharge(
	...
	ResponseConfig<GetWorkspaceAccountRechargeQueryResponseType>["data"]
> {
	const res = await client<GetWorkspaceAccountRechargeQueryResponseType>({
		method: "get",
