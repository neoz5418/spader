...
export const deleteWorkspacePathParamsSchema = z.object({
	workspace: z.string(),
});
export type DeleteWorkspacePathParamsSchema = z.infer<
	typeof deleteWorkspacePathParamsSchema
>;
/**
 ...
 */
export const deleteWorkspace422Schema = z.union([
...
export type DeleteWorkspaceMutationResponseSchema = z.infer<
	typeof deleteWorkspaceMutationResponseSchema
>;
