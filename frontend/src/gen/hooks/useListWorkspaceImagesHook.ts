...
type ListWorkspaceImagesClient = typeof client<
	ListWorkspaceImagesQueryResponseType,
	ListWorkspaceImages422Type,
	never
>;
...
export type ListWorkspaceImagesQueryKey = ReturnType<
	typeof listWorkspaceImagesQueryKey
>;
export function listWorkspaceImagesQueryOptions(
	workspace: ListWorkspaceImagesPathParamsType["workspace"],
	zone: ListWorkspaceImagesPathParamsType["zone"],
	params?: ListWorkspaceImages["queryParams"],
	options: ListWorkspaceImages["client"]["parameters"] = {},
) {
	...
	return queryOptions({
		...
		queryFn: async () => {
			const res = await client<
				ListWorkspaceImages["data"],
				ListWorkspaceImages["error"]
			>({
				method: "get",
				url: `/apis/compute/v1/workspaces/${workspace}/zones/${zone}/images`,
				params,
 ...
 */
export function useListWorkspaceImagesHook<
	TData = ListWorkspaceImages["response"],
	TQueryData = ListWorkspaceImages["response"],
	TQueryKey extends QueryKey = ListWorkspaceImagesQueryKey,
>(
	workspace: ListWorkspaceImagesPathParamsType["workspace"],
	zone: ListWorkspaceImagesPathParamsType["zone"],
	params?: ListWorkspaceImages["queryParams"],
	...
	const queryKey =
		...
		listWorkspaceImagesQueryKey(workspace, zone, params);
	const query = useQuery({
		...(listWorkspaceImagesQueryOptions(
			workspace,
			zone,
			params,
			clientOptions,
...
export const listWorkspaceImagesSuspenseQueryKey = (
	workspace: ListWorkspaceImagesPathParamsType["workspace"],
	zone: ListWorkspaceImagesPathParamsType["zone"],
	params?: ListWorkspaceImages["queryParams"],
) =>
...
export type ListWorkspaceImagesSuspenseQueryKey = ReturnType<
	typeof listWorkspaceImagesSuspenseQueryKey
>;
export function listWorkspaceImagesSuspenseQueryOptions(
	workspace: ListWorkspaceImagesPathParamsType["workspace"],
	zone: ListWorkspaceImagesPathParamsType["zone"],
	params?: ListWorkspaceImages["queryParams"],
	options: ListWorkspaceImages["client"]["parameters"] = {},
 ...
 * @link /apis/compute/v1/workspaces/:workspace/zones/:zone/images
 */
export function useListWorkspaceImagesHookSuspense<
	TData = ListWorkspaceImages["response"],
	TQueryKey extends QueryKey = ListWorkspaceImagesSuspenseQueryKey,
>(
	workspace: ListWorkspaceImagesPathParamsType["workspace"],
	zone: ListWorkspaceImagesPathParamsType["zone"],
	params?: ListWorkspaceImages["queryParams"],
	...
	const queryKey =
		queryOptions?.queryKey ??
		listWorkspaceImagesSuspenseQueryKey(workspace, zone, params);
	const query = useSuspenseQuery({
		...(listWorkspaceImagesSuspenseQueryOptions(
			workspace,
			zone,
			params,
			clientOptions,
