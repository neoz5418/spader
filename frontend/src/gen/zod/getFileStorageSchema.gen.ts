...
export const getFileStoragePathParamsSchema = z.object({
	workspace: z.string(),
	zone: z.string(),
	name: z.string(),
});
export type GetFileStoragePathParamsSchema = z.infer<
	typeof getFileStoragePathParamsSchema
>;
/**
 ...
 */
export const getFileStorage422Schema = z.union([
 ...
 * @description Successful Response
 */
export const getFileStorageQueryResponseSchema = z.lazy(
	() => fileStorageSchema,
);
export type GetFileStorageQueryResponseSchema = z.infer<
	typeof getFileStorageQueryResponseSchema
>;
