...
export const listZonesQueryParamsSchema = z
	.object({
		offset: z.number().int().min(0).default(0).optional(),
		limit: z.number().int().min(1).max(100).default(20).optional(),
	})
	.optional();
export type ListZonesQueryParamsSchema = z.infer<
	typeof listZonesQueryParamsSchema
>;
/**
 ...
 */
export const listZones422Schema = z.union([
 ...
 * @description Successful Response
 */
export const listZonesQueryResponseSchema = z.lazy(
	() => paginatedListZoneSchema,
);
export type ListZonesQueryResponseSchema = z.infer<
	typeof listZonesQueryResponseSchema
>;
