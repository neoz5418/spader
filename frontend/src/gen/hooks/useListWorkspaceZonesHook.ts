...
import type { ListWorkspaceZonesQueryResponseType, ListWorkspaceZonesPathParamsType, ListWorkspaceZonesQueryParamsType, ListWorkspaceZones400Type, ListWorkspaceZones401Type, ListWorkspaceZones404Type, ListWorkspaceZones422Type, ListWorkspaceZones429Type, ListWorkspaceZones500Type, ListWorkspaceZones503Type } from "../ts/ListWorkspaceZonesType";
import type { QueryObserverOptions, UseQueryResult, QueryKey, UseSuspenseQueryOptions, UseSuspenseQueryResult } from "@tanstack/react-query";

 type ListWorkspaceZonesClient = typeof client<ListWorkspaceZonesQueryResponseType, ListWorkspaceZones400Type | ListWorkspaceZones401Type | ListWorkspaceZones404Type | ListWorkspaceZones422Type | ListWorkspaceZones429Type | ListWorkspaceZones500Type | ListWorkspaceZones503Type, never>;
type ListWorkspaceZones = {
    data: ListWorkspaceZonesQueryResponseType;
    error: ListWorkspaceZones400Type | ListWorkspaceZones401Type | ListWorkspaceZones404Type | ListWorkspaceZones422Type | ListWorkspaceZones429Type | ListWorkspaceZones500Type | ListWorkspaceZones503Type;
    request: never;
