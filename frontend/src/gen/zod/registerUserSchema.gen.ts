 ...
 */
export const registerUser422Schema = z.union([
...
export type RegisterUserMutationRequestSchema = z.infer<
	typeof registerUserMutationRequestSchema
>;
/**
 * @description Successful Response
 */
export const registerUserMutationResponseSchema = z.lazy(() => userSchema);
export type RegisterUserMutationResponseSchema = z.infer<
	typeof registerUserMutationResponseSchema
>;
