...
import { registerUserRequestSchema, RegisterUserRequestSchema } from "@/gen/zod/registerUserRequestSchema.gen";
...
export function SignUpForm({ className, ...props }: SignUpFormProps) {
  ...
  const [userRequest, setUserRequest] = useState<RegisterUserRequest | null>(null)
  const [disabledBtn, setDisabledBtn] = useState(true)
  const [step, setStep] = useState<'register' | 'verify' | 'success'>('register')
  const { mutateAsync: sendOneTimePasswordMutationAsync } = useSendOneTimePasswordHook()
      ...
      <div className='mx-auto flex w-full flex-col justify-center space-y-2 sm:w-[480px] lg:p-8'>
        ...
        <Card className='p-6'>
          ...
          <div className={cn('grid gap-6', className)} {...props}>
            ...
            <form onSubmit={verifyForm.handleSubmit(onVerifySubmit, onInvalid)}>
              <div className='grid gap-2'>
                    ...
                    <FormItem className='space-y-1'>
                      <FormControl>
                        <PinInput
                          ...
                          onComplete={() =>{ setDisabledBtn(false); console.log('complete')}}
                          onIncomplete={() => {setDisabledBtn(true); console.log('incomplete')}  }
                        >
                ...
                />
                <Button className='mt-2' disabled={disabledBtn} loading={isPending}>
                  Verify
                </Button>
              </div>
              </form>
          ...
          <Card className='p-6'>
            ...
            <div className={cn('grid gap-6', className)} {...props}>
              <Form key='registerForm' {...registerForm}>
                <form onSubmit={registerForm.handleSubmit(onRegisterSubmit, onInvalid)}>
                  <div className='grid gap-2'>
                    <FormField
