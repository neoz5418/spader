...
import type {
	GetUser422Type,
	GetUserPathParamsType,
	GetUserQueryResponseType,
} from "../ts/GetUserType";

type GetUserClient = typeof client<
	GetUserQueryResponseType,
	GetUser422Type,
	never
>;
...
export const getUserQueryKey = (username: GetUserPathParamsType["username"]) =>
	[
		"v5",
		{ url: "/apis/user/v1/users/:username", params: { username: username } },
	] as const;
export type GetUserQueryKey = ReturnType<typeof getUserQueryKey>;
export function getUserQueryOptions(
	username: GetUserPathParamsType["username"],
	options: GetUser["client"]["parameters"] = {},
) {
 ...
 * @link /apis/user/v1/users/:username
 */
export function useGetUserHookSuspense<
	TData = GetUser["response"],
