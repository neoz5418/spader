...
export type UpdateImagePathParamsSchema = z.infer<
	typeof updateImagePathParamsSchema
>;
/**
 ...
 */
export const updateImage422Schema = z.union([
...
export type UpdateImageMutationResponseSchema = z.infer<
	typeof updateImageMutationResponseSchema
>;
