...
export const deleteWorkspaceSshKeysPathParamsSchema = z.object({
	workspace: z.string(),
	name: z.string(),
});
export type DeleteWorkspaceSshKeysPathParamsSchema = z.infer<
	typeof deleteWorkspaceSshKeysPathParamsSchema
>;
/**
 * @description Successful Response
 */
export const deleteWorkspaceSshKeys204Schema = z.any();
export type DeleteWorkspaceSshKeys204Schema = z.infer<
	typeof deleteWorkspaceSshKeys204Schema
>;
/**
 * @description Unprocessable Entity
 */
export const deleteWorkspaceSshKeys422Schema = z.union([
...
export type DeleteWorkspaceSshKeys422Schema = z.infer<
	typeof deleteWorkspaceSshKeys422Schema
>;

export const deleteWorkspaceSshKeysMutationResponseSchema = z.any();
export type DeleteWorkspaceSshKeysMutationResponseSchema = z.infer<
	typeof deleteWorkspaceSshKeysMutationResponseSchema
>;
