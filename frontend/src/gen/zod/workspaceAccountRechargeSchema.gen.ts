...
export const workspaceAccountRechargeSchema = z.object({
	...
	pay_url: z.string(),
	status: z.lazy(() => rechargeStatusSchema),
});
export type WorkspaceAccountRechargeSchema = z.infer<
	typeof workspaceAccountRechargeSchema
>;
