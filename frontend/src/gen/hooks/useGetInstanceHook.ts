...
import type { GetInstanceQueryResponseType, GetInstancePathParamsType, GetInstance400Type, GetInstance401Type, GetInstance404Type, GetInstance422Type, GetInstance429Type, GetInstance500Type, GetInstance503Type } from "../ts/GetInstanceType";
import type { QueryObserverOptions, UseQueryResult, QueryKey, UseSuspenseQueryOptions, UseSuspenseQueryResult } from "@tanstack/react-query";

 type GetInstanceClient = typeof client<GetInstanceQueryResponseType, GetInstance400Type | GetInstance401Type | GetInstance404Type | GetInstance422Type | GetInstance429Type | GetInstance500Type | GetInstance503Type, never>;
type GetInstance = {
    data: GetInstanceQueryResponseType;
    error: GetInstance400Type | GetInstance401Type | GetInstance404Type | GetInstance422Type | GetInstance429Type | GetInstance500Type | GetInstance503Type;
    request: never;
