...
class TestBillingCoupon(unittest.TestCase):
    ...
    def test_no_discount_coupon(self):
        ...
        result = no_discount_coupon.calculate_final_price(2000)
        self.assertEqual(
    ...
    def test_full_discount_coupon(self):
        ...
        result = full_discount_coupon.calculate_final_price(2000)
        self.assertEqual(
    ...
    def test_no_max_discount_limit(self):
        ...
        result = no_limit_coupon.calculate_final_price(5000)
        self.assertEqual(
