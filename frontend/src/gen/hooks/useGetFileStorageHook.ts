...
import type { GetFileStorageQueryResponseType, GetFileStoragePathParamsType, GetFileStorage422Type } from "../ts/GetFileStorageType";
import type { QueryObserverOptions, UseQueryResult, QueryKey, UseSuspenseQueryOptions, UseSuspenseQueryResult } from "@tanstack/react-query";

 type GetFileStorageClient = typeof client<GetFileStorageQueryResponseType, GetFileStorage422Type, never>;
type GetFileStorage = {
